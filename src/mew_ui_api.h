...
#define MEW_RVA_ALLOC_COMPONENT_FROM_TYPE 0x00961090ULL // This is the engine allocator that creates components from a type descriptor...
#define MEW_RVA_SCENE_REGISTER_COMPONENT 0x00962F10ULL // This registers a component with the scene manager so the game knows about it...
#define MEW_RVA_RESIZE_PTR_ARRAY 0x00D44928ULL // This grows the engine pointer arrays used by scene buckets...
#define MEW_RVA_CONTEXT_FROM_MANAGER 0x00962FB0ULL // This asks the scene manager for a UI context, creating or attaching one when safe...
#define MEW_RVA_SCENE_READY_UPDATE 0x00962820ULL // This is the scene-ready update pass where mod UI work can run safely...
#define MEW_RVA_SCENE_READY_UPDATE_STOLEN_BYTES 15 // This is the trampoline byte count for the scene-ready update hook...
#define MEW_RVA_CONTEXT_ATTACH_COMPONENT_REF 0x00047FC0ULL // This appends a component reference into the UI context list...
#define MEW_RVA_UI_FIND_CHILD_BY_NAME 0x000E86F0ULL // This finds a direct UI child by its engine narrow-string name...
#define MEW_RVA_FIND_UI_CHILD_ALT 0x0005A0B0ULL // This is the root-owned child lookup used by the text owner helpers...
#define MEW_RVA_UI_FIND_NODE_BY_PATH_OR_NAME 0x00990940ULL // This finds a UI node recursively by path or plain name...
#define MEW_RVA_UI_ROOT_SET_TEXT_STRING 0x00974250ULL // This sets root-owned text from a localization key by node name...
#define MEW_RVA_UI_ROOT_SET_TEXT_WIDE_STRING 0x009742C0ULL // This sets root-owned text from an already-built wide string...
#define MEW_RVA_INIT_NARROW_STRING 0x00052AA0ULL // This builds the engine narrow string wrapper used before lookup calls...
#define MEW_RVA_DESTROY_NARROW_STRING 0x00052730ULL // This destroys heap-backed engine narrow strings after the game is done with them...
#define MEW_RVA_ASSIGN_NARROW_STRING_LITERAL 0x00052080ULL // This writes plain role-name text into an engine narrow string slot...
#define MEW_RVA_MOVE_WIDE_STRING 0x000636D0ULL // This moves an engine wide string into another engine-owned wide string...
#define MEW_RVA_ASSIGN_WIDE_STRING_DATA 0x0005B100ULL // This copies raw wchar text into an engine wide string slot...
#define MEW_RVA_COPY_WIDE_STRING_OBJECT 0x0005B010ULL // This copy-constructs a temporary wide string for text setter calls...
#define MEW_RVA_DESTROY_WIDE_STRING 0x00052240ULL // This destroys engine wide strings that may own heap memory...
...
#define MEW_RVA_BUTTON_ACTIVATE 0x009764B0ULL // This is Button activate, used to detect accepted click edges...
#define MEW_RVA_BUTTON_ACTIVATE_STOLEN_BYTES 15 // This is the trampoline byte count for the activate hook...
#define MEW_RVA_BUTTON_CAN_ACTIVATE 0x009766C0ULL // This is the game interactability check before a button can activate...
#define MEW_RVA_BUTTON_CAN_ACTIVATE_STOLEN_BYTES 15 // This is the trampoline byte count for the can-activate hook...
#define MEW_RVA_BUTTON_TYPE_DESCRIPTOR 0x013F0210ULL // This points at the global Button type descriptor used for allocation...
#define MEW_RVA_LOCALIZATION_MANAGER 0x013BC290ULL // This points at the global localization manager used for label and text keys...
...
// Finds a child MovieClip under a root node and restarts it at a frame index...
